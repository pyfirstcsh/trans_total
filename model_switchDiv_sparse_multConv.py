...
from config import SwitchSparseMultConvConfig

logger = logging.get_logger(__name__)


class MultiplicativeLayer(nn.Module):
    def __init__(self, config: SwitchSparseMultConvConfig):
        super().__init__()
...
class MultConvAttention(nn.Module):
    def __init__(
        self, config: SwitchSparseMultConvConfig, has_relative_attention_bias=False
    ):
        super().__init__()
...
class SparseController(nn.Module):
    def __init__(self, config: SwitchSparseMultConvConfig):
        ...
        self.C2 = nn.Linear(config.d_lowrank, config.d_ff // config.num_experts)
...
class DivSparseDenseActDense(nn.Module):
    def __init__(self, config: SwitchSparseMultConvConfig) -> None:
        super().__init__()
        self.wi = nn.Linear(
            config.d_model, config.d_ff // config.num_experts, bias=False
        )
        self.wo = nn.Linear(
...
class SparseMLP(nn.Module):
    ...
    def __init__(
        self,
        config: SwitchSparseMultConvConfig,
        expert_class: nn.Module = DivSparseDenseActDense,
    ):
        super().__init__()
...
class SwitchSparseLayerFF(nn.Module):
    r"""
    Switch Transformers Feed Forward layer module. This is a wrapper around the Mixture of Experts module.

    """

    def __init__(self, config: SwitchSparseMultConvConfig, is_sparse=True):
        super().__init__()
...
class T5Block(nn.Module):
    def __init__(
        ...
        self.layer.append(SwitchSparseLayerFF(config))
...
class T5Stack(T5PreTrainedModel):
    def __init__(self, config: SwitchSparseMultConvConfig, embed_tokens=None):
...
class SwitchDivSparseMultConvForConditionalGeneration(T5PreTrainedModel):
    ...
    def from_pretrained(cls, pretrained_model_name_or_path, *model_args, **kwargs):
        ...
        if config is None:
            config = SwitchSparseMultConvConfig.from_pretrained(
